...
// This file contains the class derivative implmentation of a checksum command.
#include "checksum.h"
#include <time.h>
...
void Checksum::deserialize(string str){
...
Checksum cs;
VirtualConstructor::instance()->registerCommand(&cs);
